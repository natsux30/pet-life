...
function DetalhesProduto() {
  ...
  const recomendacoesPorPet = pets.map(function(pet) {
  ...
  function handleAddToCart() {
    ...
    alert(`${produto.title} (${quantidade}x) adicionado ao carrinho! 🛒`);
  }
  ...
  return (
    <div style={estilo.container}>
      ...
      <div style={estilo.breadcrumb}>
        <Link to="/" style={estilo.breadcrumbLink}>Home</Link>
        {' > '}
        <Link to="/loja" style={estilo.breadcrumbLink}>Loja</Link>
        {' > '}
      ...
      <div style={estilo.mainSection}>
        ...
        <div style={estilo.infoContainer}>
          <span style={estilo.categoria}>
            {produto.categoria === 'caes' ? '🐕 Cães' : 
             produto.categoria === 'gatos' ? '🐈 Gatos' : '🐾 Outros'}
          </span>
          ...
          <div style={estilo.avaliacaoContainer}>
            ...
            <span style={{ color: '#667eea', fontSize: '0.85rem', cursor: 'pointer' }}>
              | Avaliar
            </span>
          </div>
          ...
          <div style={estilo.infoGrid}>
            ...
            <div style={estilo.infoItem}>
              ...
              <span style={{
                ...
                {produto.estoque > 10 ? '✓ Em estoque' : 
                 produto.estoque > 0 ? `⚠️ Últimas ${produto.estoque} unidades` : 
                 '✗ Fora de estoque'}
              </span>
            </div>
          </div>
